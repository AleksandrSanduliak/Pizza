...
const goods = require('../helpers/cardItems');

class GoodsService {
  async getGoods(location) {
    console.log('location', location);
    const getGoodsData = await db.collection("city").doc(location).collection('goods').get();
  ...
  //   const getGoodsData = db.collection("city").doc('stpetersburg').collection('goods').doc('pizza');
  //   getGoodsData.update({
  //   title: "Пиццы",
  //   name: "pizza",
  //   anchor: "pizza",
